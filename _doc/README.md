...
Pull requests run a cheap **Tier A** [site-contract check](./site-contract.md) (`scripts/check_year_site.py`) so incomplete syncs and virtual layout chrome do not merge unnoticed.

When archival pages need to track or diverge from [virtual.aistats.org](https://virtual.aistats.org/), see [Syncing with virtual](./virtual-sync.md). The year site stays the long-term record; sync is compare-first and never paraphrases.
...
Fortunately, you shouldn't need to worry about this template language as the work is being done for you by a customised remote theme ([`aistats/jekyll-theme`](https://github.com/aistats/jekyll-theme)). This theme makes it easier for you to generate a website without lots of editing html.
