...
# {{ site.conference.short_name }} {{ site.conference.year }} Reviewer Guidelines

This page provides guidelines for reviewers for {{ site.conference.short_name }} {{ site.conference.year }}. It is seeded from recent AISTATS conferences; update year-specific policy, dates, and review-form wording before publishing.
...
19. **Code of Conduct:**
    ...
    Agree to abide by the AISTATS code of conduct. The AISTATS code of conduct can be found here: [{{ site.conference.short_name }} Code of Conduct]({{ "code-of-conduct.html" | relative_url }})
...
{% if site.author.email %}[{{ site.author.email }}](mailto:{{ site.author.email }}){% else %}<!-- TODO: set author.email in _config.yml -->{% endif %}.
